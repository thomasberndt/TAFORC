% Simulates and plots assemblages of magnetite (TM0) and 
% titanomagnetite (TM60) grains, both with a wide grain size
% distribution.
...
f_TM0 = normpdf(log10(V), log10(3.4e-27), 1);    % Wide grain size distribution
f_TM0 = f_TM0 / max(f_TM0);                      % Equal proportions
Tc_TM0 = (580+273);
Ms0_TM0 = CalculateMs0(Tc_TM0); 

f_TM60 = normpdf(log10(V), log10(3.4e-27), 1);   % Wide grain size distribution
f_TM60 = f_TM60 / max(f_TM60);                   % Equal proportions
Tc_TM60 = 200+273; 
...
try
    export_fig('../output/png/Forc/MagnetiteTitanomagnetite_widegrains.png', '-m4'); 
    export_fig('../output/pdf/Forc/MagnetiteTitanomagnetite_widegrains.pdf'); 
catch
    print(gcf, '-dpng', '../output/png/Forc/MagnetiteTitanomagnetite_widegrains.png'); 
    print(gcf, '-dpdf', '../output/pdf/Forc/MagnetiteTitanomagnetite_widegrains.pdf'); 
end
...
try
    export_fig('../output/png/Hysteresis/MagnetiteTitanomagnetite_widegrains_Hysteresis.png', '-m4'); 
    export_fig('../output/pdf/Hysteresis/MagnetiteTitanomagnetite_widegrains_Hysteresis.pdf'); 
catch
    print(gcf, '-dpng', '../output/png/Hysteresis/MagnetiteTitanomagnetite_widegrains_Hysteresis.png'); 
    print(gcf, '-dpdf', '../output/pdf/Hysteresis/MagnetiteTitanomagnetite_widegrains_Hysteresis.pdf'); 
end

% Simulates and plots assemblages of small elongated and 
% small rounded magnetite grains
...
f_elongated = 1*1.2e15*f_elongated / max(f_elongated);  % Equal proportions

N_round = 0.10;
f_round = normpdf(log10(V), log10(1.5e-24), 0.02);      % This is the same as the elongated distribution from the main scenario
...
try
    export_fig('../output/png/Forc/ElongatedRounded_smallgrains.png', '-m4'); 
    export_fig('../output/pdf/Forc/ElongatedRounded_smallgrains.pdf'); 
catch
    print(gcf, '-dpng', '../output/png/Forc/ElongatedRounded_smallgrains.png'); 
    print(gcf, '-dpdf', '../output/pdf/Forc/ElongatedRounded_smallgrains.pdf'); 
end
...
try
    export_fig('../output/png/Hysteresis/ElongatedRounded_smallgrains_Hysteresis.png', '-m4'); 
    export_fig('../output/pdf/Hysteresis/ElongatedRounded_smallgrains_Hysteresis.pdf'); 
catch
    print(gcf, '-dpng', '../output/png/Hysteresis/ElongatedRounded_smallgrains_Hysteresis.png'); 
    print(gcf, '-dpdf', '../output/pdf/Hysteresis/ElongatedRounded_smallgrains_Hysteresis.pdf'); 
end

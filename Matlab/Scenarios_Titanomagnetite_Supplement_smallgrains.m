...
% titanomagnetite (TM60) grains, both with a small grain size
% distribution.
...
f_TM0 = 1*0.8e15*f_TM0 / max(f_TM0);             % Equal proportions
Tc_TM0 = (580+273);
Ms0_TM0 = CalculateMs0(Tc_TM0); 

f_TM60 = normpdf(log10(V), log10(1.9e-24), 0.045);       % This is the same as the TM0 distribution from the main scenario
...
try
    export_fig('../output/png/Forc/MagnetiteTitanomagnetite_smallgrains.png', '-m4'); 
    export_fig('../output/pdf/Forc/MagnetiteTitanomagnetite_smallgrains.pdf'); 
catch
    print(gcf, '-dpng', '../output/png/Forc/MagnetiteTitanomagnetite_smallgrains.png'); 
    print(gcf, '-dpdf', '../output/pdf/Forc/MagnetiteTitanomagnetite_smallgrains.pdf'); 
end
...
try
    export_fig('../output/png/Hysteresis/MagnetiteTitanomagnetite_smallgrains_Hysteresis.png', '-m4'); 
    export_fig('../output/pdf/Hysteresis/MagnetiteTitanomagnetite_smallgrains_Hysteresis.pdf'); 
catch
    print(gcf, '-dpng', '../output/png/Hysteresis/MagnetiteTitanomagnetite_smallgrains_Hysteresis.png'); 
    print(gcf, '-dpdf', '../output/pdf/Hysteresis/MagnetiteTitanomagnetite_smallgrains_Hysteresis.pdf'); 
end

...
try
    export_fig('../output/png/Forc/ElongatedRounded.png', '-m4'); 
    export_fig('../output/pdf/Forc/ElongatedRounded.pdf'); 
catch
    print(gcf, '-dpng', '../output/png/Forc/ElongatedRounded.png'); 
    print(gcf, '-dpdf', '../output/pdf/Forc/ElongatedRounded.pdf'); 
end
...
try
    export_fig('../output/png/Hysteresis/ElongatedRounded_Hysteresis.png', '-m4'); 
    export_fig('../output/pdf/Hysteresis/ElongatedRounded_Hysteresis.pdf'); 
catch
    print(gcf, '-dpng', '../output/png/Hysteresis/ElongatedRounded_Hysteresis.png'); 
    print(gcf, '-dpdf', '../output/pdf/Hysteresis/ElongatedRounded_Hysteresis.pdf'); 
end

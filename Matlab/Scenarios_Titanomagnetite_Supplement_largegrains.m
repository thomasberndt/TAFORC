...
% titanomagnetite (TM60) grains, both with a large grain size
% distribution.
...
tau0  = 1e-10;
T     = 20+273;
Ha    = -0.12;                                   % Show wider range in FORC diagram
Hb    =  0.12; 
Hcmax = 0.08; 
Humax = 0.04; 
steps = 201; 

f_TM0 = normpdf(log10(V), log10(33e-24), 0.16);  % This is the same as the TM60 distribution from the main scenario
f_TM0 = 1e8*0.8e15*f_TM0 / max(f_TM0);  
Tc_TM0 = (580+273);
...
try
    export_fig('../output/png/Forc/MagnetiteTitanomagnetite_largegrains.png', '-m4'); 
    export_fig('../output/pdf/Forc/MagnetiteTitanomagnetite_largegrains.pdf'); 
catch
    print(gcf, '-dpng', '../output/png/Forc/MagnetiteTitanomagnetite_largegrains.png'); 
    print(gcf, '-dpdf', '../output/pdf/Forc/MagnetiteTitanomagnetite_largegrains.pdf'); 
end
...
try
    export_fig('../output/png/Hysteresis/MagnetiteTitanomagnetite_largegrains_Hysteresis.png', '-m4'); 
    export_fig('../output/pdf/Hysteresis/MagnetiteTitanomagnetite_largegrains_Hysteresis.pdf'); 
catch
    print(gcf, '-dpng', '../output/png/Hysteresis/MagnetiteTitanomagnetite_largegrains_Hysteresis.png'); 
    print(gcf, '-dpdf', '../output/pdf/Hysteresis/MagnetiteTitanomagnetite_largegrains_Hysteresis.pdf'); 
end
